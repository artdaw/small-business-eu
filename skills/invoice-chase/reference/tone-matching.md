...
Score each customer using Exact Online payment history for the last 12 months. Require a minimum of 3 invoices to score; fewer than 3 defaults to `occasionally-late`.
...
Every reminder includes: invoice number(s), total amount due (EUR), original due date, days overdue, and SEPA payment reference or Mollie payment link.
