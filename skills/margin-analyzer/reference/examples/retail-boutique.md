...
**Business:** Small women's clothing boutique, brick-and-mortar + webshop
**Connectors:** Exact Online (costs), Mollie (online sales), SumUp (in-store POS)
...
Exact Online division connected. Industry: "Retail — Apparel". Pre-flight passes.
...
- **Exact Online:** 14 months of COGS by product category (EUR)
- **Mollie:** 14 months of online settlement history
- **SumUp:** 14 months of in-store POS sales
...
- This example shows data from multiple sources: Mollie (online) + SumUp (in-store)
