...
as multiple rows in the Exact Online export — same vendor, same date, different amounts.
...
> Flagged: PayPal outflow of –$89.00 on March 18 has no matching Exact Online deposit.
> Possible missing transaction.

The –$89.00 is a refund to a customer. It should match a Exact Online credit memo, not
a deposit.

### ✓ Good

Separate inflows (positive) from outflows (negative) before reconciling. Match
negative processor amounts against Exact Online credit memos or refund transactions, not
deposits. Only flag an unmatched negative if no credit memo exists in Exact Online.

---

## Gotcha: Comparing gross PayPal amount to net Exact Online deposit

**Why it matters:** Exact Online often records the net bank deposit (after PayPal
...
> Discrepancy: PayPal settlement $500.00, Exact Online deposit $484.80 — delta $15.20.
...
`transaction_info.fee_amount.value`) when comparing to the Exact Online bank deposit.
