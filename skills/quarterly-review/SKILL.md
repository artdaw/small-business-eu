...
1. Pull Exact Online P&L for the quarter: revenue, COGS, gross margin, operating expenses, net margin (all EUR).
2. Compare to prior quarter and same quarter last year (if available).
3. Pull Mollie, PayPal, and SumUp settlements for the same period to validate Exact Online revenue.
4. Calculate: revenue growth %, margin change in points, top 3 revenue categories.

## Step 2 — Customer health

1. Pull CRM deal data from HubSpot, Pipedrive, or Brevo (whichever is connected): new customers won, churned, average deal size (EUR), pipeline entering next quarter.
...
2. Revenue story (trend + why) — amounts in EUR
...
If Exact Online is unreachable, stop — the QBR requires Exact Online financial data as the foundation. If payment processors (Mollie/PayPal/SumUp) are missing, skip cross-validation and note "Payment processors not connected — revenue validated from Exact Online only." If CRM (HubSpot/Pipedrive/Brevo) is missing, skip customer health (Step 2) and note it.
