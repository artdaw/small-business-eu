...
**Exact Online** (Jan 1 – Dec 31, 2024):
...
|-----------|-----------|-------|
| jenna.torres@email.com | $1,200 | Likely same as Exact Online vendor |
| designbymike@gmail.com | $2,100 | Not in Exact Online |
| Bob Nguyen | $480 | |

**Mollie** (not connected — skipped)

---

## Step 2: Aggregate and deduplicate

Cross-referencing Exact Online and PayPal:

| Payee | Exact Online | PayPal | Total | Notes |
|-------|-----------|--------|-------|-------|
| Jenna Torres | $8,400 | $1,200 | **$9,600** | Same person — email match |
| Apex Web Solutions | $15,200 | — | **$15,200** | |
| Spark Digital Inc. | $6,000 | — | **$6,000** | |
| Design by Mike (Mike unknown) | — | $2,100 | **$2,100** | Not in Exact Online; payee name unknown |
...
| Apex Web Solutions | $15,200 | Exact Online | ✅ EIN on file | "Solutions" — may be corp; confirm exemption with accountant |
| Spark Digital Inc. | $6,000 | Exact Online | ✅ EIN on file | "Inc." — likely corp-exempt; confirm with accountant |
