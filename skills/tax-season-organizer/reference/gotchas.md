...
**BAD:** Only flag vendors with an "1099 eligible" tag in the accounting system.
Many users never set this flag. Silently missing contractors is worse than over-flagging.

**GOOD:** Pull ALL vendors with ≥ $600 in payments, then note which ones are
flagged by category heuristics (consulting, freelance, contractors).
...
## PayPal / Mollie 1099-K overlap

**BAD:** Instruct the user to file 1099-NECs for all contractors paid via PayPal or Mollie.

**GOOD:** Flag the overlap and defer to the accountant.
> "Contractors paid via PayPal or Mollie may already receive a 1099-K from those
